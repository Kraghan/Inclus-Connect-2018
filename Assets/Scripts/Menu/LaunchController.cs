...
namespace Scripting.Menu
{
	class LaunchController : MonoBehaviour 
	{
		...
		{
			Managers.instance.playerManager.datas[0].isAssisted = p_toggle.isOn;
		...
		{
			Managers.instance.playerManager.datas[1].isAssisted = p_toggle.isOn;
		...
		{
			Managers.instance.playerManager.datas[2].isAssisted = p_toggle.isOn;
		...
		{
			Managers.instance.playerManager.datas[3].isAssisted = p_toggle.isOn;
